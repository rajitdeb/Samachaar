...
class FavouritesAdapter(private val onArticleClickListener: OnArticleClickListener):
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FavouritesAdapter.MyViewHolder {
        return MyViewHolder.from(parent)
    }

    override fun onBindViewHolder(holder: FavouritesAdapter.MyViewHolder, position: Int) {
